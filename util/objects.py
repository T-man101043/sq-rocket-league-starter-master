...
#From: https://github.com/RLBot/RLBotPythonExample/wiki/Quickchat
def get_game_score(packet):
...
class GoslingAgent(BaseAgent):
    ...
    def initialize_agent(self):
        ...
        self.previous_frame_own_score = 0
    ...
    def get_output(self, packet):
        ...
        if self.previous_frame_opponent_score < current_score[not self.team]:
            ...
            self.send_quick_chat(False, QuickChatSelection.Reactions_Noooo)
            # pass # TEMP disable quickchat

        self.previous_frame_opponent_score = current_score[not self.team]
        self.previous_frame_own_score = current_score[not self.team]
    ...
    def handle_quick_chat(self, index, team, quick_chat):
            # pass # TEMP disable quickchat
            if team != self.team and quick_chat == QuickChatSelection.Reactions_Siiiick:
